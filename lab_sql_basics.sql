...
#  how many clients are from each district_id? Show the results sorted
#  by the district_id in ascending order.
...
#  14;In the card table, how many cards exist for each type? Rank the result starting
...
#  15;Using the loan table, print the top 10 account_ids based on the sum of all of 
#  their loan amounts.
...
# for each unique loan duration, ordered by date and duration, both in ascending
# order. You can ignore days without any loans in your output.

SELECT date, duration, count(*) as loan_issued
FROM loan
...
#  Continuing with the previous example, rank the top 10 account_ids based 
#  on their difference.
